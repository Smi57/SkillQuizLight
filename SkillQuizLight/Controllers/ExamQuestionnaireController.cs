...
namespace SkillQuizLight.Controllers
{
    ...
    public class ExamQuestionnaireController : ControllerBase
    {
        ...
        public List<mExamQuestionnaire_Display> getQuestionnaireID(int ID)
        {
            return db.tExamQuestionnaire
        ...
        public async void postQuestionnaire(mExamQuestionnaire_Display pExamQuestionnaireDisplay, int user)
        {
            ...
            vQuestionnaireTmp.tExamDomainID = vExamQuestionnaire.getExamDomainID();
            vQuestionnaireTmp.tExamSubDomainID = vExamQuestionnaire.getExamSubDomainID();
        ...
        public async void putQuestionnaire(mExamQuestionnaire_Display pExamQuestionnaireDisplay, int user)
        {
            ...
            if (vExamQuestionnaire.getExamDomainID() != 0) { vQuestionnaireTmp.tExamDomainID = vExamQuestionnaire.getExamDomainID(); }
            if (vExamQuestionnaire.getExamSubDomainID() != 0) { vQuestionnaireTmp.tExamSubDomainID = vExamQuestionnaire.getExamSubDomainID(); }
